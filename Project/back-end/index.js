...
app.get("/map",(req,res)=>{
    res.redirect(url+"/frontend/Game/main/index.html")
})

app.get("/cardgame",(req,res)=>{
    res.redirect(url+"/frontend/Game/card_game/index.html")
})

app.get("/quizgame",(req,res)=>{
    res.redirect(url+"/frontend/Game/quiz/index.html")
})
...
app.get("/matchup",(req,res)=>{
    res.redirect(url+"/frontend/Game/drag_game/index.html")
})

app.get("/spin",(req,res)=>{
    
    console.log('Sending file:', filePath);
    res.sendFile(__dirname+"/../frontend/Game/spin/index.html")
})
