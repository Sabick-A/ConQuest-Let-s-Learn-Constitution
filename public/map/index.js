...
image.src = "/map/assets/images/SIH2.png";

const foregroundImage = new Image()
foregroundImage.src = '/map/assets/images/fore.png'

const playerDownImage = new Image()
playerDownImage.src = '/map/assets/images/playerDown.png'

const playerUpImage = new Image()
playerUpImage.src = '/map/assets/images/playerUp.png'

const playerLeftImage = new Image()
playerLeftImage.src = '/map/assets/images/playerLeft.png'

const playerRightImage = new Image()
playerRightImage.src = '/map/assets/images/playerRight.png'
